    ...
    <MuiThemeProvider>
      ...
      <div className="Page">
        ...
        <div className="AllWidthComponent">
          <a href="/"><img src="https://res.cloudinary.com/doekkaztw/image/upload/v1591374993/iPhone-SE_y8hlxf.png" alt="iPhone-SE"/></a>
        </div>
        <div className="AllWidthComponent">
          <a href="/"><img src="https://res.cloudinary.com/doekkaztw/image/upload/v1591375001/iPhone-11_cuhxkq.png" alt="iPhone-11"/></a>
        </div>
        <div className="AllWidthComponent">
          <a href="/"><img src="https://res.cloudinary.com/doekkaztw/image/upload/v1591374991/iPad-Pro_teofpb.png" alt="iPad-Pro"/></a>
        </div>
        <div className="AllWidthComponent">
          <a href="/"><img src="https://res.cloudinary.com/doekkaztw/image/upload/v1591374996/WWWDC20_owqsd1.png" alt="WWWDC20"/></a>
        </div>
        <div className="AllWidthComponent">
          <a href="/"><img src="https://res.cloudinary.com/doekkaztw/image/upload/v1591375004/WATCH_q1u6rv.png" alt="WATCH"/></a>
        </div>
        <div className="AllWidthComponent" style={{'marginLeft': '10px'}}>
          <a href="/"><img src="https://res.cloudinary.com/doekkaztw/image/upload/v1591375008/Acarde_z2asjn.png" alt="Acarde"/></a>
        </div>
        ...
        <footer className="Footer">
          ...
          <div className="FooterCopyright">
            <Grid container direction="row">
              ...
              <p style={{'marginLeft': '18em'}}><a className="FooterLinks" href="/choose-country-regionn"><img alt="USA" src="https://res.cloudinary.com/doekkaztw/image/upload/v1591374990/bandera_nrbrau.png" className="CountryFlag"/>  United States</a></p>
            </Grid>
          </div>
        </footer>
      </div>
